...
const postBeauty = function () {
  ...
  $.each('.highlight', function (element) {
    const figcaption = document.createElement('figcaption');
    const codeEl = element.querySelector('pre code[data-lang]')
    const lang = codeEl.getAttribute('data-lang');
    figcaption.setAttribute('data-lang', lang)
  ...
  $.each('div.highlight', function (element) {
    ...
    element.insertAdjacentHTML('beforeend', '<div class="operation"><span class="copy-btn"><i class="ic i-clipboard"></i></span><span class="fullscreen-btn"><i class="ic i-expand"></i></span></div>');
    ...
    if(LOCAL.nocopy) {
      ...
      copyBtn.addEventListener('click', function (event) {
        ...
        var comma = '', code = '';
        code_container.find('.cl').forEach(function(line) {
    ...
    if(code_container && code_container.find(".line").length > 15) {
